...
public class Splitter extends JFrame implements ActionListener,ItemListener
{

  JLabel LblBanner,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17;
  ...
  int csize;
  int ind;
  String[] ps={"10 KB","100 KB","120 KB","500 KB","720 KB"};
  int[] pos={10240,102400,122880,512000,737280};
  int attr[]=new int[3];
  ...
  public Splitter()
  {
    super("PowerDesk---Splitting And Merging");
	...
	LblBanner.setFont(new Font("Monotype Corsiva",Font.BOLD,78));
        LblBanner.setForeground(new Color(153,255,255));

    c.add(LblBanner,BorderLayout.NORTH);
    tp=new JTabbedPane();
    tp.setTabPlacement(JTabbedPane.NORTH_EAST);

  

    l1=new JLabel("Source File(s): ");
    ...
    r1=new JRadioButton("Predefined");
      ...
      r1.setForeground(new Color(255,153,102));
      r1.setContentAreaFilled(false);
      r1.setVisible(false);
    r2=new JRadioButton("Customized");
      r2.setBackground(Color.BLACK);
      r2.setForeground(new Color(255,153,102));
...
//    bg2.add(r4);
    ...
    r7=new JRadioButton("MB");
      ...
      r5.setForeground(new Color(153,255,255));
      r5.setContentAreaFilled(false);
      r6.setBackground(Color.BLACK);
      r6.setForeground(new Color(153,255,255));
      r6.setContentAreaFilled(false);
      r7.setBackground(Color.BLACK);
      r7.setForeground(new Color(153,255,255));
...
//    p9.add(r7);
    ...
    p8.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY), "File Size", TitledBorder.CENTER, csize, null, new Color(153,255,255)));
    p8.add(p5);
...
//    p12.add(ab1);
    ...
    Icon iconSplit =new ImageIcon("C:\\Users\\Raju Mahajan\\Desktop\\19 APR NEW\\PowerDesk-1\\src\\compression\\splitt_reflection.jpg");
    tp.addTab("SPLIT",iconSplit, p13);
    
    tp.setBackgroundAt(0, new Color(0,0,0));
    tp.setForegroundAt(0, new Color(255,255,255));

    //second tab

    l5=new JLabel("Splitted File (.jfs):");
    ...
    l8.setForeground(new Color(255,153,102));
    l9.setForeground(new Color(255,153,102));
    l10.setForeground(new Color(255,153,102));
    l11.setForeground(new Color(255,153,102));
    l12.setForeground(new Color(255,153,102));
    l13.setForeground(new Color(255,153,102));
    l14.setForeground(new Color(255,153,102));
    ...
    p17.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.DARK_GRAY), "Details", TitledBorder.CENTER, csize, null, new Color(153,255,255)));
    p17.add(l8);
    p17.add(l9);
    p17.add(l10);
    p17.add(l11);
...
//    p18.add(ab2);
    ...
    Icon iconMerge =new ImageIcon("C:\\Users\\Raju Mahajan\\Desktop\\19 APR NEW\\PowerDesk-1\\src\\compression\\merge_final_reflection.jpg");
    tp.addTab("MERGE",iconMerge, p19);
    tp.setBackgroundAt(1, new Color(0,0,0));
    tp.setForegroundAt(1, new Color(255,255,255));
    //third tab
    ...
    p13.setBackground(new Color(0,0,0));
    p14.setBackground(new Color(0,0,0));
    p15.setBackground(new Color(0,0,0));
    p16.setBackground(new Color(0,0,0));
    p17.setBackground(new Color(0,0,0));
    p18.setBackground(new Color(0,0,0));
    p19.setBackground(new Color(0,0,0));
    p20.setBackground(new Color(0,0,0));
    p21.setBackground(new Color(0,0,0));
    p22.setBackground(new Color(0,0,0));
    p23.setBackground(new Color(0,0,0));
    p24.setBackground(new Color(0,0,0));
    p25.setBackground(new Color(0,0,0));

    x1.setBackground(new Color(0,0,0));
    x2.setBackground(new Color(0,0,0));
    x3.setBackground(new Color(0,0,0));
    x4.setBackground(new Color(0,0,0));
    x5.setBackground(new Color(0,0,0));
    x6.setBackground(new Color(0,0,0));
    x7.setBackground(new Color(0,0,0));
    x8.setBackground(new Color(0,0,0));
    x9.setBackground(new Color(0,0,0));
    x10.setBackground(new Color(0,0,0));
    ...
    fc3.addChoosableFileFilter(new filter1());
     ...
     tf3.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        {
           JOptionPane.showMessageDialog((Container)null,tf3.getText()+" : This is not a valid size","",JOptionPane.OK_OPTION);
        }
      }
     });
     getConfig();
 ...
 public void actionPerformed(ActionEvent e)
 {
   ...
   else if(e.getSource()==b5)
   {
     boolean bx=true;
     if(ctr==0)
       JOptionPane.showMessageDialog((Container)null,"No source file is selected","",JOptionPane.OK_OPTION);
     else if(tf1.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split folder is entered","",JOptionPane.OK_OPTION);
     else
     {
     ...
     for(int i=0;i<ctr;i++)
     {
      ...
      if(bx)
       JOptionPane.showMessageDialog((Container)null,"Splitted Successfully!","",JOptionPane.OK_OPTION);
      else
       JOptionPane.showMessageDialog((Container)null,"This Splitting of files encounters some errors!  Only Correct files if any are Splitted Successfully!","",JOptionPane.OK_OPTION);
     }catch(Exception ef){
        JOptionPane.showMessageDialog((Container)null,"Destination folder is not entered properly","",JOptionPane.OK_OPTION);
     }
   ...
   else if(e.getSource()==b10)
   {
     ...
     if(tf4.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"No split file is entered","",JOptionPane.OK_OPTION);
     else if(!(new File(tf4.getText()).exists()))
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","",JOptionPane.OK_OPTION);
     else if(tf5.getText().equals(""))
       JOptionPane.showMessageDialog((Container)null,"Merge folder should be entered","",JOptionPane.OK_OPTION);
     else
     {
       ...
       {
        JOptionPane.showMessageDialog((Container)null,"Error occured in merging: Not merged","",JOptionPane.OK_OPTION);
       }
     }
   }
   ...
   else if(e.getSource()==b12)
   {
     try
     {
       ...
       if (!flc.exists())
        JOptionPane.showMessageDialog((Container)null,"Comment File not found!","",JOptionPane.OK_OPTION);
       else
       {
       ...
       JOptionPane.showMessageDialog((Container)null,"Unreadable error!","",JOptionPane.OK_OPTION);
     }
   }
   else if(e.getSource()==b13)
   {
    try
    {
      if (tf4.getText().equals(""))
      {
        JOptionPane.showMessageDialog((Container)null,"No split file specified!","",JOptionPane.OK_OPTION);
      }
      else if(!(new File(tf4.getText()).exists()))
      {
        JOptionPane.showMessageDialog((Container)null,"Split file you specified not found or not correct!","",JOptionPane.OK_OPTION);
      ...
      else
      {
        ...
        if(!(beg.equals("jfs")))
        {
           JOptionPane.showMessageDialog((Container)null,"Not a valid split file!","",JOptionPane.OK_OPTION);
        }
        else
        {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"Unexpected Error","",JOptionPane.OK_OPTION);
      clearlab();
    }
   ...
   else if(e.getSource()==b18)
   {
    if(tf6.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default split folder is not empty","",JOptionPane.OK_OPTION);
    else if(tf7.getText().equals(""))
      JOptionPane.showMessageDialog((Container)null,"Default merge folder is not empty","",JOptionPane.OK_OPTION);
    else
    {
     setConfig();
     getConfig();
     JOptionPane.showMessageDialog((Container)null,"Default values saved!","",JOptionPane.OK_OPTION);
    }
   }
                                  ...
                                  boolean wipe,boolean batch)
 {
    ...
    {
      JOptionPane.showMessageDialog((Container)null,"File not found","",JOptionPane.OK_OPTION);
      return 0;
    }
    try{
    if(wipe)
    {
      ...
      if((new File("A:/")).exists())
       ...
       {
         JOptionPane.showMessageDialog((Container)null,"No floppy drive found or Floppy Disk is not inserted!!","",JOptionPane.OK_OPTION);
         return 0;
       }
    }
  ...
  public int merge(String split,String dest,boolean del)
  {
    ...
    JOptionPane.showMessageDialog((Container)null,"Merged successfully!","",JOptionPane.OK_OPTION);
    return 1;
  }
 ...
 class filter1 extends javax.swing.filechooser.FileFilter
 {
  ...
  class help extends javax.swing.JFrame
  {
    ...
    help()
    {
      ...
      {
        JOptionPane.showMessageDialog((Container)null,"Unable to locate the help file!!","",JOptionPane.OK_OPTION);
      }
    }
  ...
  class about extends javax.swing.JFrame
   {
     ...
     {
       super("About ");
       la1=new JLabel("  Name       : Splitter(File Splitter)");
       la2=new JLabel("  Version    : 1.4.0(Pro)");
       la3=new JLabel("  Developed by : Abinash Alok");
       la4=new JLabel("                            SM Infotech");
       la5=new JLabel("                            India ");
       ...
       ta.setText("  This software is licensed as free software to \n"+
                   ...
                   "  please feel free to mail to:  ab_alok83@yahoo.in");
...
//      rs1.setVisible(false);
     ...
     stf2.addFocusListener(new FocusAdapter()
     {
       public void focusLost(FocusEvent fe)
       {
        ...
        { JOptionPane.showMessageDialog((Container)null,stf2.getText()+" : This is not a valid size","",JOptionPane.OK_OPTION);}
